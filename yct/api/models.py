...
class Payment(models.Model):
    student = models.ForeignKey(SchoolUser, on_delete=models.CASCADE, related_name='payments')
    ...
    def __str__(self):
        return f'{self.amount} paid by {self.student.first_name}'
    
    def save(self, *args, **kwargs):
        super(Payment, self).save(*args, **kwargs)
        self.student.update_balance(self.amount)
    class Meta:
        ordering = ('-created_at',)  
